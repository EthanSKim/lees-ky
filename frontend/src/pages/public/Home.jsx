...
import HanokIllustration from '../../components/public/hanok/HanokIllustration';
...
export default function Home() {
  ...
  return (
    <div className="home-page">
      <section className="hero hero-hanok">
        <div className="hero-hanok-illustration">
          <HanokIllustration />
        </div>
      ...
      <ScrollReveal as="section" className="home-story">
      ...
      {previewItems.length > 0 && (
        <ScrollReveal as="section" className="home-menu-preview">
      ...
      <ScrollReveal as="section" className="home-visit">
